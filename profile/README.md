...
### [AIDE - irma](https://github.com/aide-examples/aide-irma) (rapid protyping tool - PRIVATE)
This is an aide-frame based system which is basically driven by meta data. It is the dream of what "CASE" tools in the 1990s wanted to be. You describe your class model in semi formal notation and interactively design a graphical representation. At the same time SQL tables are generated and a generic three layer nackend and a modern browser UI is generated. Validation rules can be defined for memeber attributes. Sample data can be imported or generated. The example is taken from aviation industry, hence thee acronym *Intelligent Repair and Maintenance in Aviation*.
